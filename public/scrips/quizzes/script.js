//Obtener los valores para escoger el quizz
...
const start_btn = document.querySelector(".start_btn a");
...
title_text.textContent = topic; // Asignar el valor de topic al texto del elemento title

// Crear un nuevo elemento <script>
const script = document.createElement('script');

// Establecer el atributo src con la ruta del archivo JavaScript con las preguntas
script.src = quizz;

// Seleccionar el elemento donde deseas agregar el script
const head = document.head || document.getElementsByTagName('head')[0];

// Agregar el script al elemento <head>
...
function showQuetions(index)
{
    ...
    // Obteniendo la pregunta actual
    const currentQuestion = questions[index];

    // Creando el texto de la pregunta
    const que_tag = '<span>' + currentQuestion.numb + '. ' + currentQuestion.question + '</span>';
    que_text.innerHTML = que_tag;

    // Construyendo las opciones de respuesta dinámicamente
    let option_tag = '';
